/*
Controlling LEDs through UART. Press 1-4 on your keyboard to toggle LEDS 1-4 on
...
/* STEP 5.1 - Get C identifiers for the DeviceTree labels and properties' values
 * related to LEDs */
...
/* STEP 8.1 - Define the transmission buffer, which is a buffer to hold the data
...
int main(void) {
  ...
  /* STEP 9.3  - Start receiving by calling uart_rx_enable() and pass it the
